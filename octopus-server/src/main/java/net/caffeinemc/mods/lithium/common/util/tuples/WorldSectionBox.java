...
public record WorldSectionBox(int chunkX1, int chunkY1, int chunkZ1, int chunkX2, int chunkY2,
                              int chunkZ2) {
    public static WorldSectionBox entityAccessBox(AABB box) {
        ...
        return new WorldSectionBox(minX, minY, minZ, maxX, maxY, maxZ);
    }
}
