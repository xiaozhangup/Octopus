...
class LithiumDoubleStackList extends LithiumStackList {
    ...
    LithiumDoubleStackList(LithiumDoubleInventory doubleInventory, LithiumStackList first, LithiumStackList second, int maxCountPerStack) {
    ...
    static LithiumDoubleStackList getOrCreate(LithiumInventory firstInv, LithiumInventory secondInv, LithiumStackList first, LithiumStackList second) {
