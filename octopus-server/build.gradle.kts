...
paperweight {
    ...
    val fork = forks.register("octopus") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("octopus-server/paper-patches")
...
dependencies {
    implementation(project(":octopus-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Octopus",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Octopus",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "HAPPYLAND Dev",
            "Brand-Id" to "happyland:octopus",
            "Brand-Name" to "Octopus",
